...
exports.getGISTypeDetails = (modifier) => {
    ...
    if (subtype !== 0 &&
        ...
        subtype !== 6 &&
        subtype !== 7) {
        throw new Error(`Unsupported PostGIS modifier, expected 0-7, received ${subtype} (${modifier})`);
    }
    return {
        subtype,
        hasZ,
...
exports.getGISTypeModifier = (subtype, hasZ, hasM, srid) => {
    // Ref: https://github.com/postgis/postgis/blob/2.5.2/liblwgeom/liblwgeom.h.in#L156-L173
...
exports.getGISTypeName = (subtype, hasZ, hasM) => {
